...
public:
	...
	void BuildGridSystem()
	{
		...
		g_grid_size = max (1, min(_MAX_GRID_SIZE, g_node_vector.size() / 1000));  // dynamically determine the size of grid. e.g. for a testing network <100 nodes, use a grid size of 1.
